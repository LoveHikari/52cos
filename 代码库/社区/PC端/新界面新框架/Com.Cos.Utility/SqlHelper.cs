...
namespace Com.Cos.Utility
{
    ...
    ***/
    public sealed class SqlHelper
    {
        ...
        private static readonly string ConnString1 = DEncryptUtils.DESDecrypt(System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnString"].ConnectionString);//数据库连接字符串
