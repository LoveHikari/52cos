...
namespace Com.Cos.Admin
{
    ...
    public class BasePage : System.Web.UI.Page
    {
        ...
        protected const string ERROR_PAGE = "/page/404.html";
        ...
        /// 系统表所有数据
        /// </summary>
        public DataTable SysPara
        {
            get
            {
                if (Session["sysPara"] == null)
                {
                    Session["sysPara"] = SysParaBll.Instance.GetAllSysPara();
                }
                return Session["sysPara"] as DataTable;
            }
        }
        /// <summary>
        /// 客户端ip
