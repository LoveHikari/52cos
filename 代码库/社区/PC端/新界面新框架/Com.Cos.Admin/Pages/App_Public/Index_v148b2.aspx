<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_v148b2.aspx.cs" Inherits="Com.Cos.Admin.Pages.App_Public.Index_v148b2" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="col-sm-4">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <p id="pay-qrcode">
                                <a href="javascript:;">
                                    <img src="img/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                                </a>
                            </p>
                            ...
                            <div id="layouts" class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <p style="margin-left: 25px;">
                                        <hr>
                                        <span class="label label-danger">特别致谢</span> 感谢[子·梦]同学提供的contentTabs优化方案和代码！
                                    </p>
                                </div>
                            </div>
        ...
        <script src="/Style/js/welcome.min.js"></script>
    </form>
</body>
</html>
