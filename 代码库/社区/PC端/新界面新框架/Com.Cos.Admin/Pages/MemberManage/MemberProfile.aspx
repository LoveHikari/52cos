<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/App_Master/SiteMaster.Master" AutoEventWireup="true" CodeBehind="MemberProfile.aspx.cs" Inherits="Com.Cos.Admin.Pages.MemberManage.MemberProfile" %>
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    ...
                    <div class="ibox-content profile-content">
                        <h4><strong><%=MemberEntity.nickname %></strong><a href="javascript:void(0);" onclick="updatePwd();">密码修改</a></h4>
                        <p><i class="fa fa-map-marker"></i>上海市闵行区绿地科技岛广场A座2606室</p>
                        <h5>关于我</h5>
                        <address>
                            <p>姓名：<%=MemberEntity.Real_name %></p>
                            <p>生日：<%=MemberEntity.Birthday %></p>
                            <p>节操：<%=MemberEntity.integral %></p>
                            <p>热心：<%=MemberEntity.ardent %></p>
                            <p>CN币：<%=MemberEntity.CNbi %></p>
                            <p>打赏数：<%=MemberEntity.reward %></p>
                            <p>成长值：<%=MemberEntity.Growth %></p>
                            <p>注册时间：<%=MemberEntity.Reg_time %></p>
                            <p>最后登录时间：<%=MemberEntity.Last_login %></p>
                            <p>最后登录ip：<%=MemberEntity.Last_ip %></p>
                        </address>
                        <div class="row m-t-lg">
                            <div class="col-sm-4">
                                <span class="bar">5,3,9,6,5,9,7,3,5,2</span>
                                <h5><strong><%=MembershipInformation.GetWorksNum(MemberEntity.User_id.ToString()) %></strong> 作品</h5>
                            </div>
                            <div class="col-sm-4">
                                <span class="bar">5,3,9,6,5,9,7,3,5,2</span>
                                <h5><strong><%=MembershipInformation.GetCooNum(MemberEntity.User_id.ToString()) %></strong> 合作</h5>
                            </div>
                            <div class="col-sm-4">
                                <span class="bar">5,3,9,6,5,9,7,3,5,2</span>
                                <h5><strong><%=MembershipInformation.GetActivityNum(MemberEntity.User_id.ToString()) %></strong> 活动</h5>
                            </div>
                            <div class="col-sm-4">
...
<asp:Content ID="Content3" ContentPlaceHolderID="javascript" runat="server">
    ...
    <script src="/Style/js/demo/peity-demo.min.js"></script>
    <script>
        $(document).ready(function() {
            
        });

        function updatePwd(parameters) {
