...
namespace Api.Zfb.Zz
{
    ...
    public partial class _Default : System.Web.UI.Page 
    {
        ...
        protected void BtnAlipay_Click(object sender, EventArgs e)
        {
            ...
            //服务器异步通知页面路径
            string notify_url = "http://zfbzz.52cos.cn/notify_url.aspx";
            //需http://格式的完整路径，不允许加?id=123这类自定义参数

            //付款账号
            string email = "18758855660@163.com";
            //必填

            //付款账户名
            string account_name = "杭州区宇科技有限公司";
            ...
            //批次号
            string batch_no = DateTime.Now.ToString("yyyyMMddHHmmddfff");
            ...
            //付款详细数据
            string detail_data = $"0001^xmh.yxw@163.com^余晓伟^0.01^接口测试";
