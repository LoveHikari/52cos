<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/App_Master/AccountMaster.master" AutoEventWireup="true" CodeBehind="Exchange.aspx.cs" Inherits="Com.Cos.Web.Pages.HomeManage.Exchange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="form" runat="server">
    ...
    <form id="fm-ctb" class="form-horizontal" method="post" action="/Service/HomeManage/SaveExchange.ashx">
