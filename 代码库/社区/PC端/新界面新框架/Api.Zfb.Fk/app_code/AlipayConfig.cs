...
namespace Api.Zfb.Fk
{
    ...
    public class Config
    {
        ...
        public static string notify_url = $"http://{HttpContext.Current.Request.Url.Host}/Pages/notify_url.aspx";

        // 页面跳转同步通知页面路径，需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
        public static string return_url = $"http://{HttpContext.Current.Request.Url.Host}/Pages/HomeManage/History.aspx";
        ...
        public static string anti_phishing_key = Submit.Query_timestamp();
