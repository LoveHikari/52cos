...
namespace Com.Cos.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// <param name="n">开始范围</param>
        /// <param name="m">结束范围</param>
        /// <returns>替换后的字符串</returns>
        public static string Replace(this string value, string newValue, int n, int m)
        {
            StringBuilder sb = new StringBuilder();
            string s = value.Substring(n, m - n + 1);
            for (int i = 0; i < m-n+1; i++)
            {
                sb.Append(newValue);
            }
            return value.Replace(s, sb.ToString());
        }
        #region 全角半角转换
        /// <summary>
        /// 转全角的函数(SBC case)
        ...
        /// <summary>
        /// 转换成时间类型，失败则得到最小时间:1970-01-01 00:00:00
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
